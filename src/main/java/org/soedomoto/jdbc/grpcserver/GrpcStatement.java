...
public class GrpcStatement implements Statement {
    protected GrpcConnection grpcConnection;
    protected Data.Statement remoteStatement;
    ...
    public GrpcStatement(GrpcConnection grpcConnection, int resultSetType) {
        this.grpcConnection = grpcConnection;
        this.resultSetType = resultSetType;
    }

    public GrpcStatement(GrpcConnection grpcConnection, Data.Statement remoteStatement, int resultSetType) {
        this(grpcConnection, resultSetType);
